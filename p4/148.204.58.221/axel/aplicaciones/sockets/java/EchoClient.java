...
if (args.length != 1)
{
System.err.println ("Syntax - java EchoClient
hostname");
return;
}
...
// Create a packet to send to the UDP
server
...
// Create a small packet for receiving UDP
packets
...
// Catch any InterruptedIOException that is
thrown
...
// Sleep for a second, to allow user to see
packet
try
{
Thread.sleep(1000);
