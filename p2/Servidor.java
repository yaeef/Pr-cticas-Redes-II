...
public class Servidor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (pkt.tipo == Paquete.CATALOGO) {
                ...
                int idx = pkt.numSec;
                System.out.println(
                    "Solicitud de canción #" + idx + ": " + canciones.get(idx)
                );
                enviarCancion(
                    socket,
                    CARPETA + canciones.get(idx),
                    cliente,
                    puerto
                );
            }
    ...
    static void enviarCancion(
        ...
        System.out.println(
            "Enviando " + total + " paquetes con ventana " + VENTANA
        );
